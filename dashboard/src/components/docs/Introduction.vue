<template>
  <div>
    <h1>Introduction</h1>
    <p>
      Axo is a private moderation bot for Discord, designed with large servers and reliability in mind.
    </p>
    ...
    <p>
      The bot is private, so access to the bot is granted on a case by case basis.<br>
      There are plans to streamline this process in the future.
    </p>

    <h2>Configuration</h2>
    <p>
      All Axo configuration is done through the dashboard by editing a YAML config file. By default, only the server
    ...
    <h2>Plugins</h2>
    <p>
      Axo is divided into plugins: grouped functionality that can be enabled/disabled as needed, and that have their own configurations.
    </p>
