<template>
  <div class="privacy-policy">
    <div class="wrapper">
      <h1>Axo Privacy Policy</h1>

      <h2>Axo Overview</h2>
      <p>
        Azo is a moderation bot for Discord that allows server staff to
      ...
      <p>
        ...
        <a href="https://github.com/ArhanCodes/Axo">
          https://github.com/ArhanCodes/Axo
        </a>
      </p>

      <h2>Stored data</h2>
      <p>
        When Axo is used by a server, the following categories data can be
        stored by the bot.
        The specific categories of data saved for each server depends on how the
        server has configured Axo.
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>Infraction record data is kept until the server stops using Axo
        ...
        <li>User information for users logged in to the bot's web dashboard via
          Discord OAuth is stored as long as the server uses Axo
        </li>
      </ul>
      ...
      <p>
        ...
        href="mailto:arhan@otterbots.xyz">arhan@otterbots.xyz</a>.
      </p>
    </div></div>
</template>
